...
# TRAFFIC_CONFIG = Box.from_yaml(filename=f"configs/{app}-traffic.yaml")
TESTING_CONFIG = Box.from_yaml(filename=f"configs/{app}-testing.yaml")
FITTING_CONFIG = Box.from_yaml(filename=f"configs/fitting.yaml")
SCALING_CONFIG = Box.from_yaml(filename=f"configs/scaling.yaml")
