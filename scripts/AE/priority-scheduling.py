...
if __name__ == "__main__":
    ...
    print(f"Latency target data is stored in {data_path}/scalingResult/ermsPrioLatencyTargetByMS.csv")
    print(f"Container data is stored in {data_path}/scalingResult/ermsPrioContainerByMS.csv")