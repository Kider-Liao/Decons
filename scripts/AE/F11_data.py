...
parser = argparse.ArgumentParser(
    description=(
        ...
        "based on different methods: Erms, Rhythm, GrandSLAm and Firm. Noticed that, "
        "F11_data and F12_data use the same configuration, that means the latency targets "
        "and resources allocation are the same between these two scripts. "
        "To generate the corresponding figure (Figure 11 in the paper), "
        "please run F11_figure.sh. "
