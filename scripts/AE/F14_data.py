...
parser = argparse.ArgumentParser(
    description=(
        ...
        "with and without priority scheduling using Erms, GrandSLAm and Rhythm."
        "To generate the corresponding figure (Figure 14 in the paper), "
        "please run F14_figure.sh. "
...
parser.add_argument(
    ...
    "-a",
    dest="app",
    help="Application name. (`hotel-reserv`, `social-network`)",
...
os.system(f"mkdir -p {output_path}/figure_14")
sharing_main(
    data_path,
    f"{output_path}/figure_14",
    inf,
    slas_workloads,
    services,
)
