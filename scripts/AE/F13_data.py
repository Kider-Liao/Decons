...
parser = argparse.ArgumentParser(
    description=(
        ...
        "methods. To generate the corresponding figure (Figure 13 in the paper), "
        "please run F13_figure.sh. "
...
os.system(f"mv {data_path}/figure_13 {data_path}/figure_13_original")
os.system(f"mkdir -p {output_path}/figure_13")
app = "social-network"
main(
...
os.system(f"mv {data_path}/figure_13/* {output_path}/figure_13")
os.system(f"rmdir figure_13")
os.system(f"mv {data_path}/figure_13_original {data_path}/figure_13")

file = f"{output_path}/figure_13/{service}/trace_latency.csv"
...
data.to_csv(f"{output_path}/figure_13/{app}.csv", index=False)
